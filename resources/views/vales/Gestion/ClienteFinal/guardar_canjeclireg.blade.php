            ...
            <div class="container p-5">
                ...
                <div class="mb-5">
                        ...
                        <div class="row mb-12">
                            ...
                            <div class="col-md-2">
                                <div class="form-outline">
                                <label class="form-label" for="form8Example4">Monto vale</label>
                        ...
                        <div class="row mb-2">
                            <div class="col-md-8">
                                ...
                                <label class="form-label" for="form8Example4">Nombre completo</label>
                                    <input type="text"  class="form-control" name="nombre" id=""  minlength="" maxlength="" value="{{$infocli->Nombre_completo}}" required />
                                    <div class="valid-feedback">
                                    ¡Se ve bien!
                                    </div>
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-md-4">
                                ...
                                <label class="form-label" for="form8Example4">Fecha de nacimineto</label>
                                    <input type="date"  class="form-control" name="fecha_nacimiento" id=""  minlength="" value="{{$infocli->fecha_nacimiento}}" maxlength="" required />
                                    <div class="valid-feedback">
                                    ¡Se ve bien!
                                    </div>
                                    <div class="invalid-feedback">
                        ...
                        <div class="row mb-2">
                            <div class="col">
                                ...
                                <label class="form-label" for="form8Example4">CURP</label>
                                    <input type="text"  class="form-control" name="curp" id=""  minlength="" maxlength="" value="{{$infocli->curp}}" required />
                                    <div class="valid-feedback">
                                    ¡Se ve bien!
                                    </div>
                                    <div class="invalid-feedback">
                            ...
                            <div class="col">
                                ...
                                <label class="form-label" for="form8Example4">RFC</label>
                                    <input type="text"  class="form-control" name="rfc" id=""  minlength="" maxlength="" value="{{$infocli->rfc}}" required />
                                    <div class="valid-feedback">
                                    ¡Se ve bien!
                                    </div>
                                    <div class="invalid-feedback">
                        ...
                        <div class="row mb-2">
                            <div class="col">
                                ...
                                <label class="form-label" for="form8Example4">Dirección</label>
                                    <input type="text"  class="form-control" name="direccion" id=""  minlength="" maxlength="" value="{{$infocli->direccion}}" required />
                                    <div class="valid-feedback">
                                    ¡Se ve bien!
                                    </div>
                                    <div class="invalid-feedback">
                            ...
                            <div class="col">
                                ...
                                <label class="form-label" for="form8Example4">Telefono</label>
                                    <input type="text"  class="form-control" name="telefono" id=""  minlength="" maxlength="" value="{{$infocli->telefono}}" required />
                                    <div class="valid-feedback">
                                    ¡Se ve bien!
                                    </div>
                                    <div class="invalid-feedback">
                        ...
                        <div class="row mb-2">
                            <div class="col-md-8">
                                ...
                                <label class="form-label" for="form8Example4">Lugar de trabajo</label>
                                    <input type="text"  class="form-control" name="lugar_trabajo" id=""  minlength="" maxlength="" value="{{$infocli->lugar_trabajo}}" required />
                                    <div class="valid-feedback">
                                    ¡Se ve bien!
                                    </div>
                                    <div class="invalid-feedback">
                            ...
                            <div class="col-md-4">
                                ...
                                <label class="form-label" for="form8Example4">Telefono de trabajo</label>
                                    <input type="text"  class="form-control" name="telefono_trabajo" id=""  minlength="" maxlength="" value="{{$infocli->telefono_trabajo}}" required />
                                    <div class="valid-feedback">
                                    ¡Se ve bien!
                                    </div>
                                    <div class="invalid-feedback">
                        ...
                        <div class="row mb-2">
                            <div class="col">
                                ...
                                <label class="form-label" for="form8Example4">Nombre completo de referencia</label>
                                    <input type="text"  class="form-control" name="nombre_referencia" id=""  minlength="" maxlength="" value="{{$infocli->nombre_referencia}}" required />
                                    <div class="valid-feedback">
                                    ¡Se ve bien!
                                    </div>
                                    <div class="invalid-feedback">
                            ...
                            <div class="col">
                                ...
                                <label class="form-label" for="form8Example4">Dirección de referencia</label>
                                    <input type="text"  class="form-control" name="direccion_referencia" id=""  minlength="" maxlength="" value="{{$infocli->direccion_referencia}}" required />
                                    <div class="valid-feedback">
                                    ¡Se ve bien!
                                    </div>
                                    <div class="invalid-feedback">
                            ...
                            <div class="col">
                                ...
                                <label class="form-label" for="form8Example4">Telefono de referencia</label>
                                    <input type="text"  class="form-control" name="telefono_referencia" id=""  minlength="" maxlength="" value="{{$infocli->telefono_referencia}}" required />
                                    <div class="valid-feedback">
                                    ¡Se ve bien!
                                    </div>
                                    <div class="invalid-feedback">
                        ...
                        <div class="row p-3">
                            ...
                            <div class="row mb-3">
                                <label for="file1" class="drop-container2">
                                    ...
                                    ó
                                    <input type="file" id="file1" name="comprobante_ide" value="{{$infocli->ruta_comprobante_identificacion}}" required>
                                </label>
                            </div>
