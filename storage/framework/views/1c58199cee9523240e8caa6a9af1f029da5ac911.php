                ...
                <tr>
                  ...
                  <td class="td-tools">
                    ...
                    <?php elseif($vis->archivo_baja=="1"): ?>
                      <a class="text-light btn btn fas fa-eye" target="_blank"  href="bajas/baja_<?php echo e($vis->idempleado); ?>.pdf"></a>
                    <?php else: ?>
                  ...
                  <td class="bg-1">
                    ...
                    <?php else: ?>
                      <img class="pImage" src="Images/Perfil/<?php echo e($vis->idempleado); ?>.jpg" alt="foto"/>
                    <?php endif; ?>
                  </td>
                  <td class="bg-2"><?php echo e($vis->primer_nombre); ?></td>
                  <td class="bg-2"><?php echo e($vis->segundo_nombre); ?></td>
                  <td class="bg-2"><?php echo e($vis->apellido_paterno); ?></td>
                  <td class="bg-2"><?php echo e($vis->apellido_materno); ?></td>
                  <?php if($vis->estado=='A'): ?>
                  ...
                  <?php endif; ?>
                  <td class="bg-1"><?php echo e($vis->descripcion_estado); ?></td>
                  <td class="bg-1"><?php echo e($vis->estado_civil); ?></td>
                  <td class="bg-1"><?php echo e($vis->telefono); ?></td>            
                  <td class="bg-1"><?php echo e($vis->correo); ?></td>
                  <td class="bg-1"><?php echo e($vis->nacionalidad); ?></td>
                  <td class="bg-1"><?php echo e($vis->ciudad); ?></td>
                  <td class="bg-1"><?php echo e($vis->calle); ?></td>
                  <td class="bg-1"><?php echo e($vis->colonia); ?></td>
                  <td class="bg-1"><?php echo e($vis->numero_interior); ?></td>
                  <td class="bg-1"><?php echo e($vis->numero_exterior); ?></td>
                  <td class="bg-1"><?php echo e($vis->codigo_postal); ?></td>
                  <td class="bg-1"><?php echo e($vis->sexo); ?></td>
                  <td class="bg-1"><?php echo e($vis->tipo_sangre); ?></td>
                  <td class="bg-1"><?php echo e($vis->fecha_nacimiento); ?></td>
                  <td class="bg-3"><?php echo e($vis->grado_estudio); ?></td>
                  <td class="bg-3"><?php echo e($vis->puesto); ?></td>
                  <td class="bg-1"><?php echo e($vis->fecha_ingreso); ?></td>
                  <td class="bg-1"><?php echo e($vis->nombre_empresa); ?></td>
                  <td class="bg-1"><?php echo e($vis->sucursal); ?></td>
                  <td class="bg-3"><?php echo e($vis->salario_bruto); ?></td>
                  <td class="bg-3"><?php echo e($vis->salario_neto); ?></td>
                  <td class="bg-3"><?php echo e($vis->salario_fijo); ?></td>
                  <td class="bg-1"><?php echo e($vis->idinfonavit); ?></td>
                  <td class="bg-1"><?php echo e($vis->nombreinfonavit); ?></td>
                  <td class="bg-1"><?php echo e($vis->numero_credito_infonavit); ?></td>
                  <td class="bg-1"><?php echo e($vis->factor_sua); ?></td>
                  <td class="bg-1"><?php echo e($vis->descuento_quincenal); ?></td>
                  <td class="bg-3"><?php echo e($vis->banco); ?></td>
                  <td class="bg-3"><?php echo e($vis->numero_tarjeta); ?></td>
                  <td class="bg-3"><?php echo e($vis->numero_cuenta); ?></td>
                  <td class="bg-3"><?php echo e($vis->rfc); ?></td>
                  <td class="bg-3"><?php echo e($vis->nss); ?></td>
                  <td class="bg-3"><?php echo e($vis->curp); ?></td>
                  <td class="bg-1"><?php echo e($vis->fecha_ingreso_imss); ?></td>
                  <td class="bg-1"><?php echo e($vis->pago_imss); ?></td>
                  <td class="bg-1"><?php echo e($vis->excedente); ?></td>
                  <td class="bg-1"><?php echo e($vis->efectivo); ?></td>
                  <td class="bg-2"><?php echo e($vis->contacto_emergencia); ?></td>
                  <td class="bg-2"><?php echo e($vis->telefono_emergencia); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Aux sistemas\Desktop\FincreRPLaravel\resources\views/Empleados/index.blade.php ENDPATH**/ ?>