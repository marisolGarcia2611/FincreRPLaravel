      ...
      <tr>
        <td class="table-light">
            <h6 style="color: rgb(76, 74, 74)">
             <button class="fas fa-trash" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasBottom1" aria-controls="offcanvasBottom" id="<?php echo e($vis->id); ?>" ></button> </i>
             <button class="fas fa-edit" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasBottom" aria-controls="offcanvasBottom"  id="<?php echo e($vis->id); ?>" ></button> </i>
