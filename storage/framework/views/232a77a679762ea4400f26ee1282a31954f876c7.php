              ...
              <?php $__currentLoopData = $varlistaempleados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vis): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                  ...
                  <td class="td-tools">
                    ...
                    <?php else: ?>
                      <button class="btn fas fa-upload" style="color:#bfc6d4;" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvaBottomUpload" aria-controls="offcanvasBottom" id="<?php echo e($vis->id); ?>" ></button>
                    <?php endif; ?>
                  </td>
                  ...
                  <td class="bg-1"><?php echo e($vis->foto); ?></td>
                </tr>
