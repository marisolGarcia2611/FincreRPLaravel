          ...
          <div class="col-auto px-0 ">
            <div class=" offcanvas  offcanvas-start b__lateral " data-bs-scroll="true" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
                    ...
                    <div class="list-group border-0 rounded-0 text-sm-start min-vh-100">
                        <nav class="nav flex-column">
                          <div class="text-center">
                            <img  src="Images/Perfil/<?php echo e(Auth::user()->idempleado); ?>.jpg" style="width: 150px;height:150px;object-fit:cover;margin-bottom:40px;" class="rounded mx-auto d-block" alt="...">
                            <p class="fw-light"><?php echo e(Auth::user()->name); ?></p>
                          </div>
                                ...
                                <div class="accordion-item">
                                  ...
                                  <div id="<?php echo e($VAR); ?>" class="accordion-collapse collapse" aria-labelledby="<?php echo e($varcontador); ?>" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body">
                                        ...
                                        <a class="nav-link e__sidebar2 d-inline-block text-truncate" data-bs-parent="#sidebar" href="/<?php echo e($submenus->descripcion); ?>"><?php echo e($submenus->nom); ?></a><br/>
                                        <?php else: ?>
                                        <?php endif; ?>
                                        <?php ($varcontador++); ?>
                ...
                <div class="offcanvas-footer">
                  <img src="<?php echo e(asset('Images/diamod-logo.png')); ?>" width="50px" class="mb-5 rounded mx-auto d-block " alt="...">
                </div>
              </div>
        </div>
...
<?php /**PATH C:\Users\Aux sistemas\Desktop\FincreRPLaravel\resources\views/layouts/app.blade.php ENDPATH**/ ?>