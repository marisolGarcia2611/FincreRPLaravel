...
<div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="<?php echo e(asset('Images/6.png')); ?>" class="d-block w-100 carrusel__site" alt="...">
        <div class="carousel-caption text-start d-none d-md-block animate__animated animate__backInLeft">
          <div class="animate__animated animate__flip">
              <img src="<?php echo e(asset('images/logo.png')); ?>" class="size__icon animate__animated animate__flip" width="400px" alt="icon login">
          </div>
          <br/>
          <br/>
          <br/>
      ...
      <div class="carousel-item">
        <img src="<?php echo e(asset('Images/5.png')); ?>" class="d-block w-100 carrusel__site" alt="...">
        <div class="carousel-caption text-start  d-none d-md-block animate__animated animate__backInLeft">
      ...
      <div class="carousel-item">
        <img src="<?php echo e(asset('Images/4.png')); ?>" class="d-block w-100 carrusel__site" alt="...">
        <div class="carousel-caption text-start d-none d-md-block animate__animated animate__backInLeft">
  ...
  <div>
    <div class="container">
     ...
     <div class="row row-cols-1 row-cols-md-2 g-4" style="margin-bottom: 200px;">
      ...
      <div class="col">
        <div class="card push">
          <img src="<?php echo e(asset('Images/post1.jpeg')); ?>" class="card-img-top" alt="...">
          <div class="card-body">
      ...
      <div class="col">
        <div class="card push">
          <img src="<?php echo e(asset('Images/post2.jpeg')); ?>" class="card-img-top" alt="...">
          <div class="card-body">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Codigo Fuente laravel\fincreerplaravel\FincreRPLaravel\resources\views/home.blade.php ENDPATH**/ ?>